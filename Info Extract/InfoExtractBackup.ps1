...
Get-NetIPConfiguration > "ipconfig3.txt"
ipconfig /allcompartments /all > "D:\ipconfig.txt"
Tasklist > "D:\current_tasks.txt"
dir > "D:\C_directory.txt"
netstat -ano > "D:\Active_connections.txt"
netstat -s > "D:\Active_connections.txt"
Cd C:\windows
dir > "D:\Windows.txt"
cd system32
dir > "D:\system32.txt"
...
{ ‘Yes’ 
{
Copy-Item -Path C:\Windows -Destination D:\info_on_$env:computername -recurse -Force                                                            
pause
